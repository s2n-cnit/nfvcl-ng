...
from blueprints.blue_5g_base.models.blue_5g_model import SubDataNets
from blueprints.blue_oai_cn5g.models.blue_OAI_model import Snssai, Baseconfig, Dnn, Upfconfig, SNssaiUpfInfoListItem, DnnItem, Coreconfig, ServedGuamiListItem, OaiSmf, HostAliase, UpfAvailable, LocalSubscriptionInfo, QosProfile, SNssaiSmfInfoListItem, PlmnSupportListItem
