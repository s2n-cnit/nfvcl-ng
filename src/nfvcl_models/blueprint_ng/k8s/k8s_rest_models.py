...
class K8sCreateModel(BlueprintNGCreateModel):
    ...
    containerd_mirrors: Optional[dict[str, str]] = Field(default=None, description="Dict of containerd mirrors (cache). Key is the registry, value is the mirror (e.g. {'docker.io': 'https://docker-registry.tnt-lab.unige.it/v2/cache/'}). PATH override is true")
