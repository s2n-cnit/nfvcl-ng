...
conn.request("POST", "/v2/horse/rtr_request_workaround?target=10.10.10.10&username=ubuntu&password=test2024&forward_to_doc=true&action_type=DNS_RATE_LIMIT", payload, headers)
